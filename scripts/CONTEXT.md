...
Pulling shot data from `stats.nba.com` through `nba_api` on the builder's machine and writing the files under `public/data/shots/` that the page reads. This runs rarely (the 2025-26 season is complete) and never on Cloudflare.
